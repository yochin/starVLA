...
CONFIG_YAML="examples/simBenchmarks/Robocasa_365/train_files/starvla_qwengr00t_g1_dexhands_scratch80k.yaml"
RUN_ID="starvla_qwengr00t_g1_dexhands_fridge_pick_grapes_scratch80k"
RUN_DIR="$REPO_ROOT/results/Checkpoints/$RUN_ID"
CKPT="$RUN_DIR/final_model/pytorch_model.pt"

echo "=========================================================="
echo " [Step 1] GR00T scratch 80k 학습 시작 (QwenOFT 동등 비교용)"
...
echo "=========================================================="
echo " ✅ scratch80k 학습 및 모든 평가/렌더링이 완료되었습니다!"
