...
CONFIG_YAML="examples/simBenchmarks/Robocasa_365/train_files/starvla_qwengr00t_g1_dexhands_scratch80k_nostate.yaml"
RUN_ID="starvla_qwengr00t_g1_dexhands_fridge_pick_grapes_scratch80k_nostate"
RUN_DIR="$REPO_ROOT/results/Checkpoints/$RUN_ID"
CKPT="$RUN_DIR/final_model/pytorch_model.pt"

echo "=========================================================="
echo " [Step 1] GR00T scratch 80k (State 제거) 학습 시작"
echo "  설정 파일: $CONFIG_YAML"
echo "  기반 체크포인트: 없음 (베이스 Qwen3-VL backbone에서 시작)"
echo "  학습 스텝: 80,000 steps (Save/Eval: 매 20,000 steps)"
echo "  Loss 제외 관절: Head 2D (dims 0, 1) & Hand 이산 모드 (dims 10, 36)"
echo "  State 입력: 미사용 (include_state=false, state_dim=0)"
echo "=========================================================="
...
echo "  체크포인트: $CKPT"
echo "  (State 미사용 모델이므로 모든 평가에 --no_send_state 적용)"
echo "=========================================================="
...
echo "=========================================================="
echo " ✅ scratch80k_nostate 학습 및 모든 평가/렌더링이 완료되었습니다!"
