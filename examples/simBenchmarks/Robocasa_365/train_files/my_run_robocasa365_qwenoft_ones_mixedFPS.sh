...
CONFIG_YAML="examples/simBenchmarks/Robocasa_365/train_files/starvla_qwenoft_g1_dexhands_ones_mixedFPS.yaml"
RUN_ID="starvla_qwenoft_g1_dexhands_fridge_picktake_ones_mixedFPS_temp"
RUN_DIR="$REPO_ROOT/results/Checkpoints/$RUN_ID"
CKPT="$RUN_DIR/final_model/pytorch_model.pt"

echo "=========================================================="
echo " [Step 1] starVLA QwenOFT 모델 학습 시작"
echo "  설정 파일: $CONFIG_YAML"
echo "  기반 백본: playground/Pretrained_models/Qwen3-VL-4B-Instruct-Action"
...
echo "=========================================================="
echo " [Step 2] QwenOFT 학습 완료 후 자동 평가 파이프라인 시작"
echo "  체크포인트: $CKPT"
echo "=========================================================="
...
# # 2-4. Temporal Ensembling (Stride 4 = 80ms) 궤적 덤프 및 MuJoCo 3패널 비디오 렌더링
...
# echo ">> 2-5. MuJoCo 3패널 동기 비디오 렌더링 (render_replay_sync.py)"
# $PYTHON "$REPO_ROOT/examples/G1_Replay/eval_files/render_replay_sync.py" \
#     --npz "$RUN_DIR/pred_traj_ensemble.npz" \
#     --out_dir "$RUN_DIR/replay_videos_sync_ensemble"

# echo "=========================================================="
# echo " ✅ QwenOFT 학습 및 모든 평가/렌더링이 성공적으로 완료되었습니다!"
