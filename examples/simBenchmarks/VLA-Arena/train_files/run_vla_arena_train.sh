...
#
# Before running:
#   1. Download datasets:  bash examples/simBenchmarks/VLA-Arena/data_preparation.sh /path/to/storage
...
config_yaml=./examples/simBenchmarks/VLA-Arena/train_files/starvla_cotrain_vla_arena.yaml
