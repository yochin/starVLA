...
#
# Usage:
#   bash examples/simBenchmarks/VLA-Arena/eval_files/eval_vla_arena.sh [OPTIONS]
...
run_evaluation() {
    ...
    local cmd=(
        "${VLA_ARENA_python}" ./examples/simBenchmarks/VLA-Arena/eval_files/eval_vla_arena.py
