...
# Usage:
#   export DEST=/path/to/dir && bash examples/simBenchmarks/VLA-Arena/data_preparation.sh
# or
#   bash examples/simBenchmarks/VLA-Arena/data_preparation.sh /path/to/dir
#
...
if [[ -z "${DEST}" ]]; then
  ...
  echo "  export DEST=/path/to/dir && bash examples/simBenchmarks/VLA-Arena/data_preparation.sh"
  echo "  or: bash examples/simBenchmarks/VLA-Arena/data_preparation.sh /path/to/dir"
  exit 1
fi
...
do
  cp "$CUR/examples/simBenchmarks/VLA-Arena/train_files/modality.json" \
